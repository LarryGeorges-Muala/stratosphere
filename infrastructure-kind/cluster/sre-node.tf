...
### kubectl describe daemonset/node-monitoring -n staging
######
### kubectl get events -n staging
### kubectl port-forward svc/node-monitoring-api -n staging 9090:9090
### kubectl exec node-monitoring-dwkdn -n staging -it -- /bin/sh
######
###############################################################################
